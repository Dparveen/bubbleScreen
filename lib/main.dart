  ...
  void moveCircles() {
    ...
    setState(() {
      avatars = avatars.map((avatar) {
        ...
        // Add debug prints
        print("Old X: $avatarX, New X: $newX");
        print("Old Y: $avatarY, New Y: $newY");

        // Check for NaN values
        if (newX.isNaN || newY.isNaN) {
          print("NaN values detected. Check your calculations.");
          return avatar; // Return the same avatar to prevent the NaN issue from propagating
        }
